...
export async function buildOpsInsightsPayload() {
  ...
  const stripeCuratorPrices = {
    STRIPE_PRICE_REGULAR_MONTHLY: process.env.STRIPE_PRICE_REGULAR_MONTHLY,
    STRIPE_PRICE_PREMIUM_AI_MONTHLY: process.env.STRIPE_PRICE_PREMIUM_AI_MONTHLY,
    STRIPE_PRICE_BRUCE_PICKS_MONTHLY: process.env.STRIPE_PRICE_BRUCE_PICKS_MONTHLY,
    STRIPE_PRICE_GIAP_PICKS_MONTHLY: process.env.STRIPE_PRICE_GIAP_PICKS_MONTHLY,
    STRIPE_PRICE_AI_CREDITS_50: process.env.STRIPE_PRICE_AI_CREDITS_50,
  };
